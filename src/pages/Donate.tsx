    ...
    {/* Donation form */}
      <section className="py-12 bg-card">
        <div className="container mx-auto px-4 max-w-2xl">
          <div style={{ position: "relative", width: "100%", borderRadius: "24px", boxShadow: "0 4px 24px rgba(0,0,0,0.08)", overflow: "hidden" }}>
            <iframe
              title="Donation form powered by Zeffy"
              style={{ display: "block", border: 0, width: "100%", height: "750px" }}
